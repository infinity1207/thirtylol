...
urlpatterns = [
    url('^follow/$', views.follow, name='userena_follow'),
    url('^unfollow/$', views.unfollow, name='userena_unfollow'),
    url('^oauth/$', views.oauth, name='userena_oauth'),

    # override userena's urls
    ...
    url(r'^password/reset/$',
       ...
       merged_dict({'template_name': 'accounts/password_reset.html',
    ...
    url('^(?P<username>[\@\.\w-]+)/favourite/$',
        views.favourite,
        name='userena_favourite'),
